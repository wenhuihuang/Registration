...
<body>
			...
			<div class="con-content">
				...
				<div class="main-content">
						...
						<div class="article-content">
							<form action="" method="post" class="form-horizontal">
								<div class="form-group">
									<label for="phone-number" class="control-label col-md-3 col-sm-3 col-xs-3"><b class="red">*</b>身份证号码：</label>
									<div class="col col-md-9 col-sm-9 col-xs-9 clearfix">
										<!-- <input type="text" id="cardno" name="cardno" placeholder="请输入身份证号" class="form-control"> -->
										${tmpcust.idcardno }
									</div>
								</div>
								<div class="form-group">
					...
					<div class="btn-wrap">
						...
						<a href="javascript:;" class="btn btn-default btn-lg " onclick="findPwd()" >确定</a>
						<!-- position="thirdStep" -->
					</div>
				</div>
			</div>
	...
	<script>
		function sendCode(self) {
			var mobile =  '${tmpcust.mobiletelno }';
			...
			}).error(function() { alert("发送验证码失败，请重试。"); });
		...
		function findPwd(){
			var cardno = '${tmpcust.idcardno }';//$("#cardno").val();
			...
			$.post("submitFindPwd",{cardno:cardno,validCode:validcode,pwd:pwd},function(data){
				if(data.code==1){
					location.href="";
				}else{
