    ...
    <script>
        function resetSize() {
            ...
            if (windowWidth >= 1190) {
                ...
                $('.md-right-content').css({ 'width': containerWidth - 250 })
            }else if(windowWidth > 768 && windowWidth < 1200){
                $('.md-left-menu').css({ 'width': '230px' })
                $('.md-right-content').css({ 'width': containerWidth - 230 })
            } 
            else {
...
<body>
            ...
            <div class="col-md-9 col-sm-9 col-xs-12 md-right-content">
            	<c:choose>
	            	<c:when test="${isBlankField == true }">
	            		<iframe src="<%=basePath%>completemsg" frameborder="0" scrolling="yes" style="width:100%;height:99%" id="iframe" name="iframe"></iframe>
	            	</c:when>
					<c:otherwise>
		                <iframe src="default" frameborder="0" scrolling="yes" style="width:100%;height:99%" id="iframe"  name="iframe"></iframe>					
					</c:otherwise>            	
            	</c:choose>
            </div>
        </div>
    ...
    <div class="pop-wrap" style="display:none;">
        ...
        <div class="pop-content">
            ...
            <div class="pop-content-text">
                <div class="page-option-wrapper">
                    <a onclick="hidepopAfterPay(1)" href="javascript:;" class="page-option">
                        <img src="<%=resourcesPath %>/img/error_icon.png" alt="">
                    </a>
                    <a onclick="hidepopAfterPay(2)" href="javascript:;"  class="page-option">
        ...
        <script type="text/javascript">
        	function hidepopAfterPay(type){
        		
        		if(type==1){
        			$("#iframe").attr("src","<%=basePath%>fun/jiaofei");
        		}else if(type==2){
        			$("#iframe").attr("src","<%=basePath%>fun/chakan");
        		}
        		hidePop();
        	}
        </script>
